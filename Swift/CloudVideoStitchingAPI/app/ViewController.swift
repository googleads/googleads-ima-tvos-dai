  ...
  AVPlayerViewControllerDelegate
{
  ...
  func requestStream() {
    ...
    // Create a cloud video stitching API live stream request.
    let request = IMAVideoStitcherLiveStreamRequest(
      liveStreamEventID: self.liveStreamEventID,
      region: self.region,
    ...
    /*
    let request = IMAVideoStitcherVODStreamRequest(
      vodConfigID: self.vodConfigID,
      region: self.region,
      projectNumber: self.projectNumber,
      OAuthToken: self.OAuthToken,
      networkCode: self.networkCode
