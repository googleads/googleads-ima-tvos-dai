...
// VOD stream settings
// The vodConfigID for the stream from cloud stitcher.
...
static NSString *const kRegion = @"";

// Backup stream settings
...
- (void)requestStream {
  ...
  // VOD request. Comment out the IMAVideoStitcherLiveStreamRequest above and uncomment this
  // IMAVideoStitcherVODStreamRequest to switch from a livestream to a VOD stream.
